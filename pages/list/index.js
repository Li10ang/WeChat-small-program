...
Page({
  ...
  onLoad:function(options){
    ...
    var that = this;
    wx.request({
      url: 'https://release.weizhishu.com/wxlittlepro/microwxlistapi',
  ...
  checkwzs: function(){
    //微指数榜
    wx.navigateTo({
      url: '../phonehotlist/wxaccount?type=wxaccount'
    })
  },
  checkcb: function(){
    //传播榜
    wx.navigateTo({
      url: '../phonehotlist/wxaccount?type=wxspread'
    })
  },
  checkgz: function(){
    //估值榜
    wx.navigateTo({
      url: '../phonehotlist/wxaccount?type=wxvalue'
    })
  },
  checkzl: function(){
    //质量榜
    wx.navigateTo({
      url: '../phonehotlist/wxaccount?type=wxquality'
    })
  },
  checkhy: function(){
    //活跃榜
    wx.navigateTo({
      url: '../phonehotlist/wxaccount?type=wxactive'
    })
  },
  checkbw: function(){
    //爆文榜
    wx.navigateTo({
      url: '../phonehotlist/wxaccount?type=getArticles'
    })
  }
  // ,toast2Tap:function(){
  //     var obj = {}
  //     obj['toast2Hidden'] = false
  //     this.setData(obj)
  // },
  // toast2Change:function(){
  //     var obj = {}
  //     obj['toast2Hidden'] = true
  //     this.setData(obj)
  // }
})